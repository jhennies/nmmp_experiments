...
if __name__ == '__main__':
    ...
    # TODO Change here
    from init_exp_splC_z1 import meta_folder, experiment_folder
    from init_exp_splC_z1 import test_name
    from run_mc_splC_z1 import rf_cache_folder, result_key
    from detect_merges_splC_z1 import test_paths_cache_folder
    ...
    # TODO Change here
    rf_cache_name = 'rf_merges_ds_train_splA_z0_ds_train_splA_z1_ds_train_splB_z0_ds_train_splB_z1_ds_train_splC_z0/'
    min_prob_thresh = 0.3
    max_prob_thresh = 1.
