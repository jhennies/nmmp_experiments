...
# TODO: Change here
from init_exp_splA_z1 import meta_folder, source_folder, experiment_folder
from init_exp_splA_z1 import test_name
from run_mc_splA_z1 import result_key
...
gt_file = os.path.join(source_folder, 'cremi.splA.train.raw_neurons.crop.axes_xyz.split_z.h5')
