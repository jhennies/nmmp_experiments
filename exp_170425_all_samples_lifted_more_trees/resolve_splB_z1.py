...
from pipeline import resolve_false_merges_global, project_new_result
...
if __name__ == '__main__':
    ...
    project_new_result(
        test_name, meta_folder, new_nodes_filepath, experiment_folder,
        'result_resolved_global.h5'
    )