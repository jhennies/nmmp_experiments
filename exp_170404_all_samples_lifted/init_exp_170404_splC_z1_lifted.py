...
result_folder = '/mnt/localdata01/jhennies/neuraldata/results/multicut_workflow/170404_all_samples_lifted/170404_splC_z1_lifted/'
...
ds_train = DataSet(cache_folder, 'splC_z0')
ds_test = DataSet(cache_folder, 'splC_z1')
...
# Add datasets
meta.add_dataset('splC_z0', ds_train)
meta.add_dataset('splC_z1', ds_test)
