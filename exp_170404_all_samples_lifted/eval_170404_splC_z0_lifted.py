...
cache_folder = '/mnt/localdata01/jhennies/neuraldata/results/multicut_workflow/170404_all_samples_lifted/170404_splC_z0_lifted/cache/'
source_folder = '/mnt/localdata02/jhennies/neuraldata/cremi_2016/170321_resolve_false_merges/'

path_data_file = cache_folder + 'path_data/path_splC_z0.pkl'
seg_file = cache_folder + '../result.h5'
seg_key = 'z/0/test'
resolved_file = cache_folder + '../result_resolved_with_lifted_weight_5.0_t_0.3.h5'
resolved_key = 'z/0/test'
gt_file = source_folder + 'cremi.splC.train.raw_neurons_defect_correct.crop.axes_xyz.split_z.h5'
