...
result_folder = '/mnt/localdata01/jhennies/neuraldata/results/multicut_workflow/170404_all_samples_lifted/170404_splA_z0_lifted/'
...
ds_train = DataSet(cache_folder, 'splA_z1')
ds_test = DataSet(cache_folder, 'splA_z0')
...
# Add datasets
meta.add_dataset('splA_z1', ds_train)
meta.add_dataset('splA_z0', ds_test)
