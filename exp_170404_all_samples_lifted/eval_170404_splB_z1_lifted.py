...
from evaluation import resolve_merges_error_rate_obj_level
...
seg_key = 'z/1/test'
# resolved_file = cache_folder + '../result_resolved_with_lifted_t_0.3.h5'
resolved_file = cache_folder + '../result_resolved_global_solve_test_w5_t_0.3.h5'
resolved_key = 'z/1/labels'
...
for thresh in thresh_range:
    ...
    #
    # print '... no merged path in pre-seg:'
    # print '    ... at least one in resolved:'
    # print '... at least one in pre-seg:'
    # print '    ... at least one in resolved:'
    # print '... at least one in resolved:'
