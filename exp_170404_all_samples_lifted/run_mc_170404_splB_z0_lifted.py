...
cache_folder = '/mnt/localdata01/jhennies/neuraldata/results/multicut_workflow/170404_all_samples_lifted/170404_splB_z0_lifted/cache/'
meta = MetaSet(cache_folder)

meta.load()

ds_train = meta.get_dataset('splB_z1')
ds_test = meta.get_dataset('splB_z0')
...
vigra.writeHDF5(mc_seg, cache_folder + '../pre_result.h5', 'z/0/test')
