...
cache_folder = results_folder + '170404_splC_z0_lifted/cache/'
...
def resolve_false_merges_threshold_test_settings(mc_params, meta):
    ...
    rf_cache_name = 'rf_merges_ds_train_splA_z0_ds_train_splA_z1_ds_train_splB_z0_ds_train_splB_z1_ds_train_splC_z1.pkl'
