...
def resolve_false_merges_threshold_test_settings(mc_params, meta):
    ...
    result_file_name = 'result_resolved_with_lifted'
...
def resolve_false_merges_grid_search_lifted_path_weights_factor(mc_params, meta):
    ...
    for val in grid_search:
        ...
        mc_params.lifted_path_weights_factor = val
...
if __name__ == '__main__':
    ...
    resolve_false_merges_grid_search_lifted_path_weights_factor(mc_params, meta)
