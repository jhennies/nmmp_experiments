...
from init_folders import source_folder
from init_folders import project_folder
from init_folders import train_folder

# TODO Change here
experiment_folder = os.path.join(project_folder, 'splB_z1/')
