...
if __name__ == '__main__':
    ...
    for ds_id in experiment_ids:
        ...
        new_nodes_filepath = os.path.join(meta_folder, ds_name, 'new_ones_local_t0.5.pkl')
        # TODO: Change here when adding result
        result_filepath = os.path.join(project_folder, ds_name, 'result_resolved_local_t0.5.h5')
