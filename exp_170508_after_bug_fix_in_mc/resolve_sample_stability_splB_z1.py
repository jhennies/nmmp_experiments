...
if __name__ == '__main__':
    ...
    for iter in xrange(0, 5):

        test_paths_cache_folder = os.path.join(meta_folder, 'path_data_sampling_{}'.format(iter))

        # Local resolving ---------------------
        # TODO: Change here when adding result
        new_nodes_filepath = os.path.join(meta_folder, 'new_ones_local_sampling_{}.pkl'.format(iter))
        ...
        # TODO: Change here when adding result
        result_filepath = os.path.join(experiment_folder, 'result_resolved_local_sampling_{}.h5'.format(iter))
