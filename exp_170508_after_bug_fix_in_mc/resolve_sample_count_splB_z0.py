...
if __name__ == '__main__':
    ...
    from run_mc_splB_z0 import rf_cache_folder, result_key
    ...
    # TODO Change here
    rf_cache_name = 'rf_merges_ds_train_splA_z0_ds_train_splA_z1_ds_train_splB_z1_ds_train_splC_z0_ds_train_splC_z1/'
    min_prob_thresh = 0.3
    max_prob_thresh = 1.
    ...
    path_counts = [0, 5, 10, 15, 20, 25, 30]
    sampling = [1]
    # path_counts = [0]
    for spling in sampling:
        for path_count in path_counts:

            # TODO: Change here when adding result
            test_paths_cache_folder = os.path.join(meta_folder, 'path_data_path_count_{}_{}'.format(spling, path_count))
            ExperimentSettings().max_sample_size = path_count

            # Local resolving ---------------------
            # TODO: Change here when adding result
            new_nodes_filepath = os.path.join(meta_folder, 'new_ones_local_path_count_{}_{}.pkl'.format(spling, path_count))
            ...
            # TODO: Change here when adding result
            result_filepath = os.path.join(experiment_folder, 'result_resolved_local_path_count_{}_{}.h5'.format(spling, path_count))
