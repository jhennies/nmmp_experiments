...
if __name__ == '__main__':
    ...
    from init_exp_splA_z1 import test_name
    from run_mc_splA_z1 import rf_cache_folder, result_key
    from detect_merges_splA_z1 import test_paths_cache_folder
    ...
    # TODO Change here
    rf_cache_name = 'rf_merges_ds_train_splA_z0_ds_train_splB_z0_ds_train_splB_z1_ds_train_splC_z0_ds_train_splC_z1/'
    min_prob_thresh = 0.3
    max_prob_thresh = 1.
