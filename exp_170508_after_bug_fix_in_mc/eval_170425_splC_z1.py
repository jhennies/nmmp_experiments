...
# TODO: Change here
from init_exp_splC_z1 import meta_folder, source_folder, experiment_folder
from init_exp_splC_z1 import test_name
from run_mc_splC_z1 import result_key
...
gt_file = os.path.join(source_folder, 'cremi.splC.train.raw_neurons_defect_correct.crop.axes_xyz.split_z.h5')
