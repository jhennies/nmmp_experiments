...
def find_false_merges(ds_str):
    ...
    import os
    os.mkdir(cache_folder + 'path_data/')
    with open(cache_folder + 'path_data/paths.pkl', 'w') as f:
        pickle.dump(paths, f)
    with open(cache_folder + 'path_data/false_paths_predictions.pkl', 'w') as f:
        pickle.dump(false_merge_probs, f)
    with open(cache_folder + 'path_data/paths_to_objs.pkl', 'w') as f:
...
def resolve_false_merges(exp_params):
    ...
    rf_path = cache_folder + 'rf_cache/path_rfs/rf_merges_ds_train_false_merge_0_ds_train_false_merge_1_ds_train_false_merge_2_ds_train_false_merge_3_ds_train_false_merge_4.pkl'
